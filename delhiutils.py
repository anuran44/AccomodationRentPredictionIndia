...
def loading():
    ...
    with open("DelhiColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:221]
        __seller = __data_columns[221:224]
        __nature = __data_columns[224:226]
        __typeofstay = __data_columns[226:232]
        __furniture = __data_columns[232:235]

    global __model
    with open("Delhi_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
