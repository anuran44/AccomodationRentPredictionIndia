...
def loading():
    ...
    with open("columns.json",'r') as f:
        ...
        __locations = __data_columns[3:194]
        __seller = __data_columns[194:197]
        __nature = __data_columns[197:199]
        __typeofstay = __data_columns[199:205]
        __furniture = __data_columns[205:208]
    
    global __model
    with open("Mumbai_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
...
if __name__ == '__main__':
    loading()
    print(get_estimatedprice('agent',4, 'bhk', 'apartment','andheri east',2600,'furnished',6))
