...
import json
import ahmedabadutils
import math
with open("AhmedabadColumns.json",'r') as f:
      __data_columns = json.load(f)['data_columns']
      __locations1 = __data_columns[3:77]
      __seller1 = __data_columns[77:80]
      __nature1 = __data_columns[80:82]
      __typeofstay1 = __data_columns[82:88]
      __furniture1 = __data_columns[88:91]
def app():
    
        st.title("Metropolitan Rents :-")
        html_temp = """
        <div style="background-color:tomato;padding:10px">
        <h2 style="color:white;text-align:center;">Ahmedabad Accomodation Rent Prediction App </h2>
        </div>
         """
        ...
        if st.button("Predict"):
             result = math.ceil(ahmedabadutils.starting(seller,bedroom,a,nature,location,area,furniture,bathroom))
