...
import chennaiutils
import math
with open("ChennaiColumns.json",'r') as f:
      __data_columns = json.load(f)['data_columns']
      __locations1 = __data_columns[3:141]
      __seller1 = __data_columns[141:144]
      __nature1 = __data_columns[144:146]
      __typeofstay1 = __data_columns[146:152]
      __furniture1 = __data_columns[152:155]
def app():
    
        st.title("Metropolitan Rents :-")
        html_temp = """
        <div style="background-color:tomato;padding:10px">
        <h2 style="color:white;text-align:center;">Chennai Accomodation Rent Prediction App </h2>
        </div>
         """
        ...
        if st.button("Predict"):
             result = math.ceil(chennaiutils.starting(seller,bedroom,a,nature,location,area,furniture,bathroom))
