...
def loading():
    ...
    with open("BangaloreColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:254]
        __seller = __data_columns[254:257]
        __nature = __data_columns[257:259]
        __typeofstay = __data_columns[259:265]
        __furniture = __data_columns[265:268]

    global __model
    with open("Bangalore_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
