...
def loading():
    ...
    with open("AhmedabadColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:77]
        __seller = __data_columns[77:80]
        __nature = __data_columns[80:82]
        __typeofstay = __data_columns[82:88]
        __furniture = __data_columns[88:91]

    global __model
    with open("Ahmedabad_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
