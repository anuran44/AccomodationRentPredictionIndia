...
def loading():
    ...
    with open("ChennaiColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:141]
        __seller = __data_columns[141:144]
        __nature = __data_columns[144:146]
        __typeofstay = __data_columns[146:152]
        __furniture = __data_columns[152:155]

    global __model
    with open("Chennai_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
