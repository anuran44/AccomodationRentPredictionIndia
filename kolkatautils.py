...
def loading():
    ...
    with open("KolkataColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:116]
        __seller = __data_columns[116:119]
        __nature = __data_columns[119:121]
        __typeofstay = __data_columns[121:126]
        __furniture = __data_columns[126:129]

    global __model
    with open("Kolkata_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
