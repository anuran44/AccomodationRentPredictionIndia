...
import json
import hyderabadutils
import math
with open("HyderabadColumns.json",'r') as f:
      __data_columns = json.load(f)['data_columns']
      __locations1 = __data_columns[3:132]
      __seller1 = __data_columns[132:135]
      __nature1 = __data_columns[135:137]
      __typeofstay1 = __data_columns[137:143]
      __furniture1 = __data_columns[143:146]
def app():
    
        st.title("Metropolitan Rents :-")
        html_temp = """
        <div style="background-color:tomato;padding:10px">
        <h2 style="color:white;text-align:center;">Hyderabad Accomodation Rent Prediction App </h2>
        </div>
         """
        ...
        if st.button("Predict"):
             result = math.ceil(hyderabadutils.starting(seller,bedroom,a,nature,location,area,furniture,bathroom))
