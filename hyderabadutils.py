...
def loading():
    ...
    with open("HyderabadColumns.json",'r') as f:
        ...
        __locations = __data_columns[3:132]
        __seller = __data_columns[132:135]
        __nature = __data_columns[135:137]
        __typeofstay = __data_columns[137:143]
        __furniture = __data_columns[143:146]

    global __model
    with open("Hyderabad_Accomodation_Rent_Price_Prediction_Model.pkl",'rb') as f:
